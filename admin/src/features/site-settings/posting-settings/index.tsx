            ...
            <div className='grid gap-6'>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>设置标题和正文的长度限制。</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>配置附件上传的相关限制。</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <FormField
                    control={form.control}
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {form.watch('uploadControl.authorizedExtensions').map((ext: string) => (
                        <Badge key={ext} variant='secondary' className='pl-2 pr-1 py-1'>
                          {ext}
                          <Button
                            type='button'
                            variant='ghost'
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>设置帖子发布后的修改与删除时限。</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <div className='grid gap-4 md:grid-cols-2'>
                    <FormField
