...
const navGroups: NavGroup[] = [
  {
    title: 'GooseForum',
    items: [
      { title: '站点统计', url: '/manage/metrics', icon: Monitor },
      { title: '用户管理', url: '/manage/users', icon: UserCog },
      { title: '角色管理', url: '/manage/roles', icon: ShieldCheck },
      { title: '分类管理', url: '/manage/categories', icon: Tags },
      { title: '帖子管理', url: '/manage/posts', icon: FileText },
      { title: '友情链接', url: '/manage/links', icon: Link },
      { title: '赞助管理', url: '/manage/sponsors', icon: Heart },
      { title: '徽章管理', url: '/manage/badges', icon: Award },
    ],
  },
  {
    title: '站点设置',
    items: [
      { title: '基础信息', url: '/manage/settings/site-info', icon: PanelsTopLeft },
      { title: '发信服务', url: '/manage/settings/mail', icon: Mail },
      { title: '安全与注册', url: '/manage/settings/security', icon: ShieldCheck },
      { title: '发布内容', url: '/manage/settings/posting', icon: FileText },
      { title: '系统公告', url: '/manage/settings/announcement', icon: Megaphone },
    ],
  },
]
