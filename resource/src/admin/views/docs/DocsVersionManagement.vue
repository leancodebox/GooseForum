<template>
  <div class="p-4">
    ...
    <div class="flex justify-between items-center mb-2">
      <h2 class="text-xl font-bold text-base-content">文档版本管理</h2>
    ...
    <dialog id="version_modal" class="modal">
      <div class="modal-box w-11/12 max-w-2xl">
        ...
        <h3 class="font-bold text-lg mb-4">{{ isEditing ? '编辑版本' : '新建版本' }}</h3>
    ...
    <dialog id="directory_modal" class="modal">
      <div class="modal-box w-11/12 max-w-4xl">
        ...
        <h3 class="font-bold text-lg mb-4">编辑目录结构 - {{ editingVersion?.name }}</h3>
