...
export default {
  ...
  oidcConsent: {
    ...
    clientId: 'Client ID',
    trust: 'Make sure you trust this app. You can revoke access in your account settings at any time.',
    deny: 'Deny',
  ...
  categoriesPage: {
    ...
    subtitle: 'Browse community spaces and find conversations that interest you.',
  ...
  publish: {
    ...
    mainCategoryHint: 'The first category, “{category}”, decides who can read this topic',
  ...
  accessGroups: {
    ...
    enabled: 'Enabled',
    systemGroupHint: 'everyone and registered are system groups without stored memberships.',
    ...
    categoryPermissionsDescription: 'Set the capability each system or custom group receives in this category.',
    ...
    joinDescription: 'Join a group to access the restricted categories granted to it.',
    noJoinableGroups: 'No groups accept applications',
    noJoinableGroupsHint: 'Invitation-only groups require an administrator to add you.',
    ...
    memberHint: 'Members receive the group’s category capabilities. Group managers can also review join applications, but cannot change group settings, members, category grants, or moderate content.',
    ...
    enabledHint: 'Disabling the group immediately revokes the category capabilities it grants.',
    groupNameRequired: 'Enter an access group name',
    deleteGroupTitle: 'Delete access group',
    removeMemberTitle: 'Remove group member',
    removeMemberConfirm: 'Remove “{name}” from this access group? Their associated permissions are revoked immediately.',
    systemKey: { everyone: 'All visitors and members', registered: 'Signed-in members' },
    joinModeDescription: { invite_only: 'Only administrators can add members directly.', application: 'Users can apply and group managers or administrators review the request.' },
    joinMode: { system: 'System membership', invite_only: 'Invitation only', application: 'Applications allowed' },
    memberRole: { member: 'Member', manager: 'Group manager (reviews)' },
    level: { none: 'No access', read: 'View only', reply: 'Join discussions', create: 'Publish topics', manage: 'Moderate content' },
    levelHint: { none: 'no permissions', read: 'view content', reply: 'view and reply', create: 'view, reply, and post', manage: 'all permissions' },
  },
  image: {
