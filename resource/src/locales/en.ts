...
export default {
  ...
  publish: {
    ...
    restrictedSingleCategory: 'Restricted categories must be selected alone',
  ...
  accessGroups: {
    ...
    restrictionTitle: 'Make a public category restricted',
    restrictionDescription: '“{category}” has {count} multi-category topics that must be converted first.',
    restrictionWarning: 'This changes the visibility of topics, replies, and images. The conversion runs in one database transaction.',
    keepCategory: 'Keep only this category',
    ...
    memberHint: 'Add members directly or review pending applications for application groups.',
    ...
    memberRole: { member: 'Member', manager: 'Group manager' },
    level: { none: 'No access', read: 'Read', reply: 'Reply', create: 'Create', manage: 'Manage' },
  },
  image: {
