...
export default {
  ...
  themePreview: {
    ...
    sampleArticleTitle: 'The title of a topic post',
    sampleArticleBody: 'This simulates body text, links, quotes, and code blocks. Theme variables should keep content readable in both light and dark modes — especially body text, borders, and muted text.',
    sampleArticleQuote: 'Color hierarchy should be quiet, but never vague.',
