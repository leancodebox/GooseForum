...
export default {
  ...
  publish: {
    ...
    restrictedSingleCategory: 'Le categorie riservate vanno selezionate singolarmente',
  ...
  accessGroups: {
    ...
    restrictionTitle: 'Rendi riservata una categoria pubblica',
    restrictionDescription: '“{category}” contiene {count} discussioni con più categorie da convertire.',
    restrictionWarning: 'La visibilità di discussioni, risposte e immagini cambierà. La conversione avviene in una singola transazione.',
    keepCategory: 'Mantieni solo questa categoria',
    removeCategory: 'Rimuovi questa categoria',
    ...
    memberHint: 'Aggiungi membri direttamente o esamina le richieste in attesa.',
    ...
    memberRole: { member: 'Membro', manager: 'Gestore del gruppo' },
    level: { none: 'Nessun accesso', read: 'Lettura', reply: 'Risposta', create: 'Creazione', manage: 'Gestione' },
  },
  image: {
