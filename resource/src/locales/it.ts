...
export default {
  ...
  oidcConsent: {
    ...
    clientId: 'ID client',
    trust: 'Assicurati di fidarti di questa app. Puoi revocare l’accesso nelle impostazioni dell’account in qualsiasi momento.',
    deny: 'Rifiuta',
  ...
  categoriesPage: {
    ...
    subtitle: 'Esplora gli spazi della community e trova le discussioni che ti interessano.',
  ...
  publish: {
    ...
    mainCategoryHint: 'La prima categoria, “{category}”, decide chi può leggere questa discussione',
  ...
  accessGroups: {
    ...
    groupFormHint: 'I gruppi possono essere solo su invito o accettare richieste.',
    enabled: 'Attivo',
    systemGroupHint: 'everyone e registered sono gruppi di sistema senza membri memorizzati.',
    ...
    categoryPermissionsDescription: 'Imposta la capacità assegnata a ogni gruppo di sistema o personalizzato in questa categoria.',
    ...
    permissionHint: 'Le capacità sono cumulative; nessun permesso significa nessun accesso.',
    members: 'Membri',
    ...
    joinDescription: 'Unisciti a un gruppo per accedere alle categorie riservate autorizzate.',
    noJoinableGroups: 'Nessun gruppo accetta richieste',
    noJoinableGroupsHint: 'I gruppi solo su invito richiedono l’aggiunta da parte di un amministratore.',
    ...
    memberHint: 'I membri ricevono le capacità del gruppo. I gestori possono anche esaminare le richieste di adesione, ma non possono modificare gruppo, membri, permessi o moderare contenuti.',
    ...
    enabledHint: 'La disattivazione revoca immediatamente le capacità concesse dal gruppo.',
    ...
    removeMemberConfirm: 'Rimuovere “{name}” da questo gruppo? I permessi associati verranno revocati immediatamente.',
    systemKey: { everyone: 'Tutti i visitatori e membri', registered: 'Membri autenticati' },
    joinModeDescription: { invite_only: 'Solo gli amministratori possono aggiungere membri.', application: 'Gli utenti possono richiedere l’accesso; gestori e amministratori esaminano la richiesta.' },
    joinMode: { system: 'Sistema', invite_only: 'Solo invito', application: 'Richieste abilitate' },
    memberRole: { member: 'Membro', manager: 'Gestore (revisioni)' },
    level: { none: 'Nessun accesso', read: 'Solo visualizzazione', reply: 'Partecipa', create: 'Pubblica argomenti', manage: 'Modera contenuti' },
    levelHint: { none: 'nessun permesso', read: 'visualizza contenuti', reply: 'visualizza e rispondi', create: 'visualizza, rispondi e pubblica', manage: 'tutti i permessi' },
  },
  image: {
