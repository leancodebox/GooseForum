...
export default {
  ...
  accessGroups: {
    ...
    categoryPermissionsDescription: '集中设置每个系统组和自定义组在该分类中拥有的能力。',
    ...
    public: '公开',
    restricted: '受限',
    memberHint: '成员获得该组的分类能力；组经理额外可以审核入组申请，但不能修改组设置、成员、分类授权或管理社区内容。',
    ...
    removeMemberConfirm: '确定从当前访问组移除“{name}”吗？该用户会立即失去对应权限。',
    systemKey: { everyone: '所有访客与成员', registered: '已登录成员' },
    joinModeDescription: { invite_only: '仅管理员可以直接添加成员。', application: '用户可以提交申请，由组经理或管理员审核。' },
    joinMode: { system: '系统成员', invite_only: '仅邀请', application: '允许申请' },
    memberRole: { member: '成员', manager: '组经理（审核申请）' },
    level: { none: '不可访问', read: '仅查看', reply: '可参与讨论', create: '可发布主题', manage: '内容管理' },
    levelHint: { none: '无权限', read: '查看内容', reply: '含查看、回复', create: '含查看、回复、发帖', manage: '等同版主、全部权限' },
  },
  image: {
    selectFile: '请选择图片文件',
