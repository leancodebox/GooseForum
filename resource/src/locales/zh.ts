...
export default {
  ...
  publish: {
    ...
    restrictedSingleCategory: '受限分类只能单选',
  ...
  accessGroups: {
    ...
    restrictionTitle: '将公开分类改为受限分类',
    restrictionDescription: '“{category}”有 {count} 个多分类主题需要先转换。',
    restrictionWarning: '这会改变主题及其回复、图片的可见范围，操作将在同一数据库事务内完成。',
    keepCategory: '主题只保留此分类',
    removeCategory: '从主题移除此分类',
    ...
    public: '公开',
    restricted: '受限',
    memberHint: '直接添加成员，或处理开放申请组的待审核申请。',
    ...
    memberRole: { member: '成员', manager: '组经理' },
    level: { none: '无权限', read: '读取', reply: '回复', create: '发帖', manage: '管理' },
  },
  image: {
    selectFile: '请选择图片文件',
