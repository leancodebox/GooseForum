...
export default {
  ...
  oidcConsent: {
    ...
    expired: 'リクエストの有効期限が切れました。アプリに戻り、再度ログインしてください。',
    ...
    clientId: 'クライアント ID',
    trust: '信頼できるアプリか確認してください。アクセス権はアカウント設定からいつでも取り消せます。',
    deny: '拒否',
    approve: '許可して続行',
    openid: '本人確認を行う',
  ...
  publish: {
    ...
    mainCategoryHint: '最初のカテゴリー「{category}」がこのトピックを読める人を決めます',
  ...
  accessGroups: {
    ...
    enabled: '有効',
    systemGroupHint: 'everyone と registered はメンバー行を持たないシステムグループです。',
    systemImmutable: 'システムグループは変更できません。',
    categoryPermissions: 'カテゴリ権限',
    configureAccess: '権限',
    categoryPermissionsTitle: '「{category}」の権限',
    categoryPermissionsDescription: 'このカテゴリーで各システムグループまたはカスタムグループに付与する権限を設定します。',
    ...
    joinDescription: 'グループに参加すると、許可された制限付きカテゴリにアクセスできます。',
    ...
    public: '公開',
    restricted: '制限付き',
    memberHint: 'メンバーはグループのカテゴリ権限を取得します。グループ管理者は参加申請も審査できますが、グループ設定・メンバー・カテゴリ権限の変更やコンテンツ管理はできません。',
    ...
    joinModeLabel: '参加方法',
    enabledHint: '無効にすると、このグループが付与したカテゴリ権限は直ちに失効します。',
    groupNameRequired: 'アクセスグループ名を入力してください',
    deleteGroupTitle: 'アクセスグループを削除',
    removeMemberTitle: 'グループメンバーを削除',
    removeMemberConfirm: '「{name}」をこのグループから削除しますか？関連する権限は直ちに失効します。',
    systemKey: { everyone: 'すべての訪問者とメンバー', registered: 'ログイン済みメンバー' },
    joinModeDescription: { invite_only: '管理者だけがメンバーを直接追加できます。', application: 'ユーザーが申請し、グループ管理者または管理者が審査します。' },
    joinMode: { system: 'システム', invite_only: '招待のみ', application: '申請可能' },
    memberRole: { member: 'メンバー', manager: 'グループ管理者（申請審査）' },
    level: { none: 'アクセス不可', read: '閲覧のみ', reply: '議論に参加', create: 'トピックを公開', manage: 'コンテンツ管理' },
    levelHint: { none: '権限なし', read: 'コンテンツ閲覧', reply: '閲覧・返信', create: '閲覧・返信・投稿', manage: 'すべての権限' },
  },
  image: {
