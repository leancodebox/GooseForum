...
export default {
  ...
  publish: {
    ...
    restrictedSingleCategory: '制限付きカテゴリーは1つだけ選択できます',
  ...
  accessGroups: {
    ...
    restrictionTitle: '公開カテゴリを制限付きに変更',
    restrictionDescription: '「{category}」には変換が必要な複数カテゴリのトピックが {count} 件あります。',
    restrictionWarning: 'トピック、返信、画像の公開範囲が変わります。処理は1つのトランザクションで実行されます。',
    keepCategory: 'このカテゴリだけを残す',
    removeCategory: 'このカテゴリを外す',
    ...
    public: '公開',
    restricted: '制限付き',
    memberHint: 'メンバーを直接追加するか、参加申請を審査します。',
    ...
    memberRole: { member: 'メンバー', manager: 'グループ管理者' },
    level: { none: '権限なし', read: '閲覧', reply: '返信', create: '投稿', manage: '管理' },
  },
  image: {
