              ...
              <Transition name="gf-menu">
                ...
                >
                  <div class="rounded-md border border-gray-100 bg-white py-1 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)]">
                    ...
                    <a v-if="layout.viewer.canAccessAdmin" href="/admin" class="flex items-center gap-2 px-3 py-1.5 text-sm text-amber-700 transition-colors duration-150 hover:bg-amber-50">
