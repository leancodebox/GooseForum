...
import { Alert, AlertDescription, AlertTitle } from '@gooseforum/react/components/ui/alert'
...
import { Field, FieldDescription, FieldError, FieldGroup, FieldLabel } from '@gooseforum/react/components/ui/field'
import { Empty, EmptyDescription, EmptyHeader, EmptyMedia, EmptyTitle } from '@gooseforum/react/components/ui/empty'
import { DropdownMenu, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuTrigger } from '@gooseforum/react/components/ui/dropdown-menu'
import { Input } from '@gooseforum/react/components/ui/input'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@gooseforum/react/components/ui/select'
import { Sheet, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetTitle } from '@gooseforum/react/components/ui/sheet'
import { Spinner } from '@gooseforum/react/components/ui/spinner'
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@gooseforum/react/components/ui/table'
...
export function CategoriesManagementPage({ api, permissions, text }: CategoriesManagementPageProps) {
  ...
  }, [api, canManageAccess, canManageCategories, text])
