...
export interface PostingSettings { textControl:{minPostLength:number;maxPostLength:number;minTitleLength:number;maxTitleLength:number;newUserPostCooldownMinutes:number;maxDailyTopicsPerUser:number};uploadControl:{allowAttachments:boolean;authorizedExtensions:string[];maxAttachmentSizeKb:number;maxDailyUploadsPerUser:number;newUserUploadCooldownMinutes:number} }
