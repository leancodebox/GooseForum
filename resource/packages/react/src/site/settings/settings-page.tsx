  ...
  return (
    <main className="min-w-0 pb-8">
      <section className="overflow-hidden rounded-xl border bg-background">
        <div
          className="h-20 border-b bg-muted bg-cover bg-center sm:h-24"
          style={{
        ...
        <div className="px-4 pb-4 sm:px-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="flex min-w-0 gap-4">
              <button
                type="button"
                className="group relative -mt-9 size-24 shrink-0 rounded-full outline-none focus-visible:ring-4 focus-visible:ring-primary/20 sm:-mt-10 sm:size-28"
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button type="button" variant="outline" onClick={crop.choose}>
        ...
        {status || error ? (
          <Alert
            ...
            className="mx-4 mb-3 w-auto sm:mx-5"
          >
            <AlertDescription>{error || status}</AlertDescription>
          </Alert>
        ) : null}
        <nav
          className="flex overflow-x-auto border-t bg-muted/30 px-3"
        ...
        {activeTab === "binding" || activeTab === "applications" ? (
          <ConnectionsSettings
            section={activeTab}
            showStatus={showStatus}
            showError={showError}
...
const defaultCover =
  "linear-gradient(135deg, var(--muted), color-mix(in oklab, var(--info) 15%, var(--background)), var(--muted))";
