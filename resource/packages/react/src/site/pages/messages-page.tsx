...
import { announceUnreadStatus } from "../../runtime/unread-status";
...
export function MessagesPageView({
  ...
  }, [activePeerId, runtime.api.chat, t]);
  ...
  return (
    <main className="h-[calc(100dvh-4rem)] min-h-0 min-w-0 overflow-hidden sm:-mx-5 sm:-my-3 md:mx-0 md:my-0 md:h-[calc(100dvh-5.5rem)] md:min-h-[620px] md:pb-3">
      <section className="grid h-full overflow-hidden bg-background md:grid-cols-[300px_minmax(0,1fr)] md:rounded-xl md:border">
        <aside
          className={cn(
        ...
        >
          <header className="flex h-14 shrink-0 items-center justify-between border-b bg-background px-4 md:h-15">
            <h1 className="text-base font-bold md:text-lg">{t("title")}</h1>
            <Button
              type="button"
              variant="ghost"
              size="icon-sm"
              ...
              <ItemGroup className="gap-0">
                {filteredConversations.map((conversation) => (
                  <Item
                    ...
                    size="sm"
                    className={cn(
                      "rounded-none border-b px-4 py-3",
        ...
        >
          {active ? (
            <div className="flex min-h-0 w-full flex-col">
              <header className="flex h-14 shrink-0 items-center justify-between border-b px-3 md:h-15 md:px-4">
              ...
              <MessageScrollerProvider autoScroll defaultScrollPosition="end">
                <MessageScroller className="min-h-0 flex-1">
                  ...
                  >
                    <MessageScrollerContent className="gap-3 px-3 py-4 md:gap-4 md:px-4">
                            ...
                            >
                              ...
                              >
                                ...
                                <MessageContent className="w-auto max-w-full gap-1">
                                  <div
                                    className={cn(
                                      "whitespace-pre-wrap rounded-xl px-3 py-2 text-sm leading-relaxed shadow-sm md:px-4",
                                      message.isSelf
              ...
              <footer className="shrink-0 border-t bg-background/95 px-3 py-2 md:px-4 md:py-3">
                <form
            ...
            <Empty className="hidden min-h-0 flex-1 border-0 md:flex">
              <EmptyHeader>
                <EmptyMedia variant="icon">
                  <MessageSquare />
                </EmptyMedia>
