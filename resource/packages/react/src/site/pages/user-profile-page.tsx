          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="flex min-w-0 gap-4">
              <ProfileAvatar
                ...
                className="-mt-9 size-24 sm:-mt-10 sm:size-28"
              />
...
const defaultCover =
  "linear-gradient(135deg, var(--muted) 0%, color-mix(in oklab, var(--info) 16%, var(--background)) 52%, var(--muted) 100%)";
...
function CompactTopic({
  ...
  return (
    <GooseLink
      href={topic.url}
      className="grid gap-2 py-3 sm:grid-cols-[minmax(0,1fr)_72px_88px] sm:items-center"
    >
      ...
      <span className="hidden text-center text-sm font-semibold tabular-nums text-foreground/75 sm:block">
