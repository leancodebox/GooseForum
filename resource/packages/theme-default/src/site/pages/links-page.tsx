      ...
      <div className="grid gap-0 lg:gap-5 xl:grid-cols-[minmax(0,1fr)_260px]">
        <div className="flex min-w-0 flex-col gap-0 lg:gap-6">
          {page.groups.map((group) => (
            <section key={group.name} className="flex flex-col gap-0 lg:gap-2.5">
              ...
              <div className="grid grid-cols-1 gap-0 lg:gap-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                {group.links.map((link) => (
                  <a
                    ...
                    className="group min-w-0 border-b bg-background px-4 py-3 lg:rounded-xl lg:border lg:p-2 transition-colors hover:border-primary/30 hover:bg-primary/5"
                  >
