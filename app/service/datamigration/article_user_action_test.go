...
func TestBackfillArticleUserActionMergesLegacyRows(t *testing.T) {
	...
	got := articleUserAction.GetByArticleId(1, 10)
	...
	if inactive := articleUserAction.GetByArticleId(2, 10); inactive.Id != 0 {
...
func createLegacyArticleActionTables(t *testing.T) {
	...
	db.Connect().Where("1 = 1").Delete(&articleUserAction.Entity{})
}
