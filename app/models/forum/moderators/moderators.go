...
type Entity struct {
	...
	UserId    uint64    `gorm:"column:user_id;not null;default:0;uniqueIndex:idx_moderator_scope_user;index:idx_moderator_user_status,priority:1;" json:"userId"`
	...
	ScopeId   uint64    `gorm:"column:scope_id;not null;default:0;uniqueIndex:idx_moderator_scope_user;index:idx_moderator_scope_status,priority:2;" json:"scopeId"`
