...
type Entity struct {
	...
	UserId       uint64     `gorm:"column:user_id;not null;default:0;uniqueIndex:uniq_user_topic_action,priority:1;index:idx_tua_user_id,priority:1;index:idx_tua_user_bookmark,priority:1;index:idx_tua_user_watch,priority:1;index:idx_tua_watch_notify,priority:2" json:"userId"`
	TopicId      uint64     `gorm:"column:topic_id;not null;default:0;uniqueIndex:uniq_user_topic_action,priority:2;index:idx_tua_watch_notify,priority:1" json:"topicId"`
