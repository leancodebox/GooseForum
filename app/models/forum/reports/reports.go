...
type Entity struct {
	Id         uint64     `gorm:"primaryKey;column:id;autoIncrement;not null;index:idx_reports_status_id,priority:2,sort:desc;index:idx_reports_status_article_id,priority:3,sort:desc;index:idx_reports_status_topic_id,priority:3,sort:desc;" json:"id"`
	...
	Status     string     `gorm:"column:status;type:varchar(32);not null;default:'open';index:idx_reports_status_id,priority:1;index:idx_reports_status_article_id,priority:1;index:idx_reports_status_topic_id,priority:1;index:idx_reports_reporter_target_status,priority:4;" json:"status"`
