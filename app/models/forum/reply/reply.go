...
type Entity struct {
	...
	ArticleId uint64    `gorm:"column:article_id;type:bigint unsigned;not null;default:0;index:idx_reply_article_created;index:idx_reply_article_id,priority:1;" json:"articleId"` //
