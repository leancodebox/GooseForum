...
type Entity struct {
	Id              uint64         `gorm:"primaryKey;column:id;autoIncrement;not null;index:idx_articles_list_default,priority:5,sort:desc;index:idx_articles_list_hot,priority:4,sort:desc;index:idx_articles_list_popular,priority:4,sort:desc;index:idx_articles_list_new,priority:4,sort:desc;" json:"id"` //
	...
	ArticleStatus   int8           `gorm:"column:article_status;type:tinyint;not null;default:0;index:idx_user_status;index:idx_articles_list_default,priority:1;index:idx_articles_list_hot,priority:1;index:idx_articles_list_popular,priority:1;index:idx_articles_list_new,priority:1;" json:"articleStatus"` // 文章状态：0 草稿 1 发布
	ProcessStatus   int8           `gorm:"column:process_status;type:tinyint;not null;default:0;index:idx_user_status;index:idx_articles_list_default,priority:2;index:idx_articles_list_hot,priority:2;index:idx_articles_list_popular,priority:2;index:idx_articles_list_new,priority:2;" json:"processStatus"` // 管理状态：0 正常 1 封禁
