...
type Entity struct {
	Id            uint64         `gorm:"primaryKey;column:id;autoIncrement;not null;index:idx_topics_list_default,priority:5,sort:desc;index:idx_topics_list_hot,priority:4,sort:desc;index:idx_topics_list_popular,priority:4,sort:desc;index:idx_topics_list_new,priority:4,sort:desc;" json:"id"`
	...
	UserId        uint64         `gorm:"column:user_id;type:bigint unsigned;not null;default:0;index:idx_topics_user_status,priority:1;" json:"userId"`
	...
	PinWeight     int            `gorm:"column:pin_weight;type:int;not null;default:0;index:idx_topics_list_default,priority:3,sort:desc;" json:"pinWeight"`
	...
	UpdatedAt     time.Time      `gorm:"column:updated_at;autoUpdateTime;index:idx_topics_list_default,priority:4,sort:desc;" json:"updatedAt"`
