...
type Entity struct {
	...
	ConvId    uint64    `gorm:"column:conv_id;type:bigint unsigned;not null;default:0;index:idx_conv_time,priority:1;index:idx_conv_unread,priority:1;index:idx_conv_id,priority:1" json:"convId"` // 所属对话ID
	...
	IsRead    int       `gorm:"column:is_read;type:tinyint(1);not null;default:0;index:idx_conv_unread,priority:2" json:"isRead"`                                                                  // 该消息是否被对方读取
