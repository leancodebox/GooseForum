...
type Entity struct {
	...
	ConvId    uint64    `gorm:"column:conv_id;type:bigint unsigned;not null;default:0;index:idx_conv_time,priority:1;index:idx_conv_unread,priority:1" json:"convId"` // 所属对话ID
