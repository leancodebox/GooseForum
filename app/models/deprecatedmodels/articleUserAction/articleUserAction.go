...
type Entity struct {
	...
	UserId       uint64     `gorm:"column:user_id;not null;default:0;uniqueIndex:uniq_user_article_action,priority:1;index:idx_aus_user_id,priority:1;index:idx_aus_user_bookmark,priority:1;index:idx_aus_user_watch,priority:1;index:idx_aus_watch_notify,priority:2" json:"userId"`
	ArticleId    uint64     `gorm:"column:article_id;not null;default:0;uniqueIndex:uniq_user_article_action,priority:2;index:idx_aus_watch_notify,priority:1" json:"articleId"`
