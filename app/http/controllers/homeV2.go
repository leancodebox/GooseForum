...
func HomeV2(c *gin.Context) {
	pageMeta := viewrender.NewPageMetaBuilder().
		SetTitle("GooseForum V2 - Fresh Experience").
		SetDescription("The new face of GooseForum").
		SetCanonicalURL(component.BuildCanonicalHref(c)).
		Build()

	viewrender.SafeRender(c, "index_v2.gohtml", HomeData{
